      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mt-4 mb-8 text-balance">
              ...
              {proceso.map((paso) => {
                ...
                return (
                  <div key={paso.step} className="flex gap-4">
                    ...
                    <div>
                      <h4 className="text-lg sm:text-xl font-bold mb-2 text-white">{paso.title}</h4>
          ...
          <div className="relative">
            ...
            <div className="relative bg-slate-900 border border-slate-700 rounded-2xl p-4 sm:p-6 shadow-2xl">
                ...
                {chatDemo.map((msg, i) =>
                  msg.from === 'user' ? (
                    <div key={i} className="flex items-end gap-2">
                      ...
                      <div className="bg-slate-800 p-3 rounded-2xl rounded-bl-none max-w-[85%] sm:max-w-[80%] text-slate-300">
                        {msg.text}
                      </div>
                    </div>
                  ) : (
                    <div key={i} className="flex items-end gap-2 flex-row-reverse">
                      ...
                      <div className="bg-cyan-900/40 border border-cyan-500/30 p-3 rounded-2xl rounded-br-none max-w-[85%] sm:max-w-[80%] text-cyan-100">
                        {msg.text}
                      </div>
                    </div>
                  )
